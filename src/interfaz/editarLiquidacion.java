 ...
 * @author SISTEMAS
 */
public class editarLiquidacion extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(editarLiquidacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
